...
\linespread{1.08} % A little extra line spread is better for the Palatino font
...
$if(title)$
%DRS
\title{\vspace{-1in}\Large $title$ \vspace{-1in}$if(thanks)$\thanks{$thanks$}$endif$}
\title{\vspace{-0.5in}\Large Membranes, motors, and molecular modeling \vspace{-1in}}
\fancypagestyle{title}{%
  ...
  \fancyhead[R]{Research Plan -- Summary}
}%
