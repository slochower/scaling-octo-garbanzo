...
\usepackage[top=0.5in,bottom=0.8in,left=0.5in,right=0.5in]{geometry} % Reduce the size of the margin
...
$if(title)$
%DRS
\title{\vspace{-0.5in} $title$ \vspace{-1in}$if(thanks)$\thanks{$thanks$}$endif$}
